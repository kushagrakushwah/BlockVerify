# BlockVerify a Fake Product Identification System Using Blockchain

**SHELL Club VNIT Nagpur | Summer Project 2026**  
**Stack:** Solidity · Truffle · Ganache · Web3.js · HTML/CSS/JS  
**Duration:** 16 Weeks but we will do it in less 
